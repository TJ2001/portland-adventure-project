...
export class FoursquareService {
	...
	getFoursquare() {
		...
		var options = new RequestOptions({
			search: new URLSearchParams("near=portland&query=sushi&client_id=AHT1VTGLT0FOCHG2UTAXQE2GX4ZDR1VU1W0X2EWGY5CRZLAN&client_secret=AOC1LDHKLETPD4JCWVBPJDCDRS3QHBWLZLOPZ3OPII3WEPL4&v=20140806&m=foursquare")
		});
